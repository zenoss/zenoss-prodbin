...
'Edit': [  
            {  'action': 'dialog_setProductionState?isOrganizer=True',
               ...
               'ordering': 80.0,
               'permissions': ('Change Device',)},
            {  'action': 'dialog_setPriority_global?isOrganizer:boolean=True',
               'allowed_classes': (  'DeviceClass',
                                     'DeviceGroup',
                                     'Location',
                                     'System'),
               ...
               'ordering': 70.0,
               'permissions': ('Change Device',)},
             {  'action': 'dialog_setGroups?isOrganizer:boolean=True',
               'allowed_classes': (  'DeviceClass',
                                     'DeviceGroup',
                                     'Location',
                                     'System'),
                ...
                'ordering': 40.0,
                'permissions': ('Change Device',)},
             {  'action': 'dialog_setSystems?isOrganizer:boolean=True',
                'allowed_classes': ( 'DeviceClass',
                                     'DeviceGroup',
                                     'Location',
                                     'System'),
                ...
                'ordering': 30.0,
                'permissions': ('Change Device',)},
             {  'action': 'dialog_setLocation?isOrganizer:boolean=True',
                'description': 'Set Location...',
                'allowed_classes': ( 'DeviceClass',
                                     'DeviceGroup',
                                     'Location',
                ...
                'ordering': 20.0,
                'permissions': ('Change Device',)},
            {  'action':'dialog_setPerformanceMonitor?isOrganizer:boolean=True',
               'description': 'Set Perf Monitor...',
               'id': 'setPerformanceMonitor',
               'allowed_classes': ( 'DeviceClass',
                                     'DeviceGroup',
