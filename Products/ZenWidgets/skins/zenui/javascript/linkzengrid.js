...
var LinkZenGridBuffer = Class.create();

LinkZenGridBuffer.prototype = {
...
var LinkZenGrid = Class.create();

LinkZenGrid.prototype = {
    ...
    query: function(offset) {
        var url = this.url || 'getJSONLinkInfo';
    ...
    getBlankRow: function(indx) {
        ...
        return TR({'class':'linkzengrid_rows'}, cells);
    },
    ...
    connectHeaders: function(cells) {
        ...
        this.lastparams['orderby']='OSI_layer';
        ...
        if (this.lastparams['orderby']==f) {
            switch(this.lastparams['orderdir']) {
                ...
                case ('desc'):
                    ...
                    this.refreshWithParams({'orderby':'OSI_layer','orderdir':'asc'});
                    return;
            }
        } else {
            setStyle(cell, {
    ...
    refreshFields: function() {
        ...
        r = [['Link Id',20.0],['Endpoint A',16.0],['Endpoint B',16.0],
             ['OSI Layer',16.0],['Link Type',14.0],['Entry Method',10.0]]
        this.fields=r;
    ...
    setLinkBatchProps: function(method, extraarg) {
        url = this.absurl + '/setLinkBatchProps';
