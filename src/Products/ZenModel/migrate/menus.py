...
menuxml = os.path.join(os.path.dirname(_zm.__file__), "data", "menus.xml")
...
class MenuRelations(Migrate.Step):
    ...
    def cutover(self, dmd):
        ...
        def hasmenus(x):
            return hasattr(x, "zenMenus")

        if hasmenus(dmd):
            dmd.zenMenus.removeRelation()
        if hasmenus(dmd.Devices):
            dmd.Devices.zenMenus.removeRelation()
        if hasmenus(dmd.Networks):
        ...
        dmd.buildMenus(
            {
                ...
                "More": [
                    ...
                    {
                        "action": "objTemplates",
                        "allowed_classes": ["Device", "HardDisk"],
                ...
                "ActionRuleWindow_list": [
                    {
                        "action": "dialog_addActionRuleWindow",
                ...
                "Administrator_list": [
                    {
                        "action": "dialog_addAdministrator",
                ...
                "MaintenanceWindow_list": [
                    {
                        "action": "dialog_addMaintenanceWindow",
                ...
                "Subnetworks": [
                    {
                        "action": 'javascript:submitFormToMethod("subnetworkForm", "discoverDevices")',
                ...
                "objTemplates": [
                    {
                        "action": "dialog_addLocalTemplate",
                        "allowed_classes": ("Device",),
