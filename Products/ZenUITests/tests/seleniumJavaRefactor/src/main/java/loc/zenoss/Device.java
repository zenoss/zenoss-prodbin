...
public class Device {
     ...
     * @param sClient the DefaultSelenium instance
     * */
    public void addMultipleDevicesManually(HashMap<String, String> pair, DefaultSelenium sClient) throws Exception {
        //Go to Infrastructure
        sClient.click("link=Infrastructure");
        //Click on + button
        this.sClient.click("//table[@id='adddevice-button']");
    ...
    public void setHwProduct(String hwProduct) {
    ...
    public DefaultSelenium getsClient() {
        return sClient;
    }

    public void setsClient(DefaultSelenium sClient) {
        this.sClient = sClient;
    }
