...
class test_addRabbitMQLogFilters(unittest.TestCase, common.ServiceMigrationTestCase):
    """
    Test adding LogFilters for RabbitMQ logs issue addressed by ZEN-28081
    """
    initial_servicedef = 'zenoss-resmgr-5.1.3.json'
    expected_servicedef = initial_servicedef        # because addZeneventserverstdioLogFilters doesn't change Service objects
