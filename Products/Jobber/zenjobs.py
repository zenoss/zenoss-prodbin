...
class CeleryZenJobs(ZenDaemon):
    """Zenoss wrapper around Celery."""

    mname = "zenjobs"  # For logging

    def __init__(self, *args, **kwargs):
        """Initialize a CeleryZenJobs instance."""
    ...
    def buildOptions(self):
        """Add our command line options to ZCmdBase command line options."""
...
def task_prerun_handler(
    signal=None, sender=None, task_id=None, task=None, args=None, kwargs=None,
):
    """Handle the task_prerun signal."""
    try:
