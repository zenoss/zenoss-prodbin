...
from Products.ZenEvents.syslog_h import (
    LOG_ALERT, LOG_AUTH, LOG_AUTHPRIV, LOG_CRITICAL, LOG_CRON, LOG_DAEMON,
    LOG_DEBUG, LOG_EMERGENCY, LOG_ERRROR, LOG_FAC, LOG_FACMASK, LOG_FTP,
    ...
    LOG_MAKEPRI, LOG_MASK, LOG_NEWS, LOG_NFACILITIES, LOG_NOTICE, LOG_PRI,
    LOG_PRIMASK, LOG_SYSLOG, LOG_UNPACK, LOG_UPTO, LOG_USER, LOG_UUCP,
    LOG_WARNING, fac_names, fac_values, pri_names, pri_values)
