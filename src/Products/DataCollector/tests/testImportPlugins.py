...
class ImportPlugins(BaseTestCase):
    def test_simple(self):
        ...
        """
        loader = PluginLoader(
            here("plugins"), "zenoss.noimports", "plugins", CoreImporter()
        )
    ...
    def test_internal_imports(self):
        ...
        """
        loader = PluginLoader(
            here("plugins"), "zenoss.withimports", "plugins", CoreImporter()
        )
        plugin = loader.create()
    ...
    def test_other_pkg(self):
        ...
        loader2 = PluginLoader(
            here("otherplugins"), "zenoss.noimports", "plugins", CoreImporter()
        )
