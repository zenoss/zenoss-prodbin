...
from Products.ZenCallHome.VersionHistory \
    import KeyedVersionHistoryCallHomeCollector, VERSION_START_KEY, \
...
class TestVersionHistoryCollector(KeyedVersionHistoryCallHomeCollector):
    ...
    """
    def __init__(self):
        super(TestVersionHistoryCollector,self).__init__(TEST_ENTITY, TEST_KEY_MAP)
...
class testVersionHistory(BaseTestCase):
    ...
    def testVersionHistory(self):
        ...
        self.assertEquals( REPORT_DATE_VALUE_1, historyRecord[VERSION_START_KEY] )
        ...
        self.assertTrue( VERSION_START_KEY in historyRecord )
        self.assertEquals( REPORT_DATE_VALUE_3, historyRecord[VERSION_START_KEY] )
        self.assertTrue( PROP1_TARGET_KEY in historyRecord )
        self.assertEquals( HISTPROP1_SECONDVALUE, historyRecord[PROP1_TARGET_KEY] )
        self.assertTrue( PROP2_TARGET_KEY in historyRecord )
        self.assertEquals( HISTPROP2_VALUE, historyRecord[PROP2_TARGET_KEY] )
