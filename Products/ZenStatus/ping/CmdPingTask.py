...
class CmdPingTask(ZenStatus.PingTask):
    ...
    def _pingIp(self):
        ...
        while attempts < maxTries:
            attempts += 1
            """we need to increase the packet size to atleast 16 because 64bit version of ping does not return RTT data if 
                                                                packet lenght is < 16. This is from :http://www.linuxcommand.org/man_pages/ping8.html:
                                                                ...
                                                                Timeval is 16 bytes long on x86-64 and 8 bytes long on x86.
            """
