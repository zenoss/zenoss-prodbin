...
#    with ASMQTransaction(publisher.channel) as txn:
#        publisher.publish(msg)
#        publisher.publish(msg2)
#
class ASMQTransaction(object):
    def __init__(self, channel):
        self.datamgr = ASMQDataManager(channel)
