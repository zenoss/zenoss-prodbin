    ...
    stateProvider.onStateReady(function() {
        ...
        Ext.apply(Zenoss.devices, {
            ...
            addMultiDevicePopUP: new Zenoss.Action({
                ...
                handler: function () {
                    ...
                    window.location = Ext.String.format('/zport/dmd/addDevices?came_from={0}', loc);
                }
            }),
        ...
        function getTreeDropWarnings(dropTargetNode, droppedRecords) {
            ...
            if (dropTargetNode && droppedRecords && dropTargetNode.data && dropTargetNode.data.path &&
                ...
                var droppedClasses = Ext.Array.map(droppedRecords, function (r) {
                    return r.data.pythonClass;
                });
                if (Ext.Array.some(droppedClasses, function (droppedClass) {
                        return dropTargetClass !== droppedClass;
                    })) {
        ...
        */
            ...
            listeners: {
                ...
                contextchange: function (grid, uid) {
                    REMOTE.getInfo({uid: uid, keys: ['name', 'description', 'address']}, function (result) {
                        ...
                        function encoder(element, index, array) {
                        ...
                        menuItems.push({
                            ...
                            handler: function () {
                                ...
                                dialog.getForm().load({
                                    params: {
                                        uid: node.data.uid,
                                        keys: ['id', 'description', 'address', 'connectionInfo']
                                    },
                                    success: function () {
                                        dialog.show();
                                    },
        ...
        footerBar.on('buttonClick', function (actionName, id, values) {
            ...
            switch (actionName) {
                ...
                case 'addClass':
                    tree.addChildNode(Ext.apply(values, {type: 'organizer'}));
                    break;
                case 'addOrganizer':
