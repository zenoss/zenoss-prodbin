...
public class IPServices {
	 ...
	 */
	public static boolean addIPServiceOrganizer(String organizerName, DefaultSelenium sClient) throws Exception
	{
	 ...
	 * @throws Generic Exception
	 */
	public static boolean addIPService(String serviceName, String organizerName, DefaultSelenium sClient) throws Exception
	{
	 ...
	 * @throws Generic Exception
	 */
	public static boolean addIPService(String serviceName, DefaultSelenium sClient) throws Exception
	{
		//Add service
		sClient.click("//table[@id='footer_add_button']/tbody/tr[2]/td[2]/em");
		sClient.click("//span[text()='Add Service']");
