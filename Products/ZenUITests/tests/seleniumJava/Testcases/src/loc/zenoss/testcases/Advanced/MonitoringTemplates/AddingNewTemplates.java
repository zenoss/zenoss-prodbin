...
public class AddingNewTemplates {
	private static SeleneseTestCase selenese = null;
	private static DefaultSelenium sClient = null;
	
	private static int testCaseID = 3573;
	...
	@BeforeClass
	 public static void setUpBeforeClass() throws Exception {
		...
		@Test
		public void addingNewTemplates() throws Exception{
			...
			// Verify that the template is highlighted
			org.junit.Assert.assertEquals("true", sClient.getEval("window.document.activeElement.innerHTML.match('/Devices') != null;"));
			// Do mouse over element to verify template options are present (Data Sources, Thresholds and Graph Definitions)
			sClient.mouseOver("//div[@id='dataSourceTreeGrid']");
			sClient.mouseOver("//div[@id='thresholdGrid']");
			sClient.mouseOver("//div[@id='graphGrid']");
			// End
