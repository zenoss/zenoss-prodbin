...
_modelchange_filename = os.path.join(
    ZenJobs.get("logpath"), "modelchange-worker.log"
)
...
def configure_logging(logfile="main", **kw):
    ...
    if logfile in ("main", "modelchange"):
        ...
        if logfile == "main":
            ...
            _main_handler["filename"] = _modelchange_filename
