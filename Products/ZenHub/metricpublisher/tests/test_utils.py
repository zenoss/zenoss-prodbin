...
class UtilsTest(TestCase):
    ...
    def test_exponential_backoff(self):
        ...
        #func.side_effect = exception_instace
    ...
    def test_basic_auth_string_content(self):
        ...
        result = basic_auth_string_content(username=username, password=password)
        self.assertEqual(result, auth_str)
...
class DelayedMeterTest(TestCase):
    ...
    def test_mark(self, eventlet):
        ...
        eventlet.spawn_after.assert_called_with(10, self.delayedMeter._pushMark)
        self.assertEqual(self.delayedMeter._pushThread,
                         eventlet.spawn_after.return_value)
